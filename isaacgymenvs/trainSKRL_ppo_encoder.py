...
for i in range(0,3):
    ...
    models_ppo = {  "policy": StochasticActorHeightmap(env.observation_space, env.action_space, network_features=[256,160,128], encoder_features=[20,6], activation_function="relu"),
    ...
    cfg_ppo["experiment"]["experiment_name"] = "encoder_test3"
    ...
    cfg_trainer = {"timesteps": 100000, "headlesAs": True}
